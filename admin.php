...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-maroon elevation-2">
    <!-- Brand Logo -->
    <a href="?admin=beranda" class="brand-link navbar-primary">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="?admin=pengguna" class="nav-link">
              <img src='dist/img/svg/manager.svg' width='25'>
              <p>
                Data Pengguna
              </p>
            </a>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?admin=lapaset" class="nav-link">
              ...
              <li class="nav-item">
                <a href="?admin=cetakpeminjaman" class="nav-link">
                  <i class="far fa-circle nav-icon text-teal"></i>
...
<span id="clock"></span></button>
    ...
    <section class="content">
      ...
      case 'lapaset' : include('lapasett.php');break;
