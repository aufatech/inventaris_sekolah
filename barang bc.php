...
<div class="col-12 animated bounce">
          <div class="card card-pink">
            <div class="card-header">
              <h3 class="card-title">Data Aset Barang</h3>
              <div class="card-tools">
              <button class='btn btn-sm btn-flat btn-success animated swing' data-toggle='modal' data-target='#tambahakun'><i class='fa fa-check'></i> Tambah Barang</button>
              </div>
            </div>
            ...
            <div class="card-body ">
              <table id="example1" class="table table-bordered table-striped ">
                ...
                <tr bgcolor="pink">
                  ...
                  <th width="30px">Jumlah Barang/Satuan</th>
                  <th width="30px">Ruang</th>
                ...
                <tr>
                  <td>2</td>
                  <td>2.202003.1.0001</td>
                  <td>Kursi</td>
                  <td>03 Maret 2021</td>
                  <td>32</td>
                  <td>Kelas 7.1</td>
                  <td>Laik</td>
                  <td><a href="?admin=edita&&update=<?php echo $data[0] ?>" class="btn btn-info btn-sm">Detail</a>
            ...
            <div class="modal-body">
              <form action='akun_simpan.php' method='post'>
                 <div class="row">
                  ...
                  <input type='text' name='t_noakun' class='form-control' value="2.202003.9.001" required='true' disabled="tr" />
                </div>
                              </div>
                             <div class="col-sm-6">
                              <div class='form-group'>
                ...
                <div class='form-group'>
                  <label>Tanggal Pembelian Barang</label>
                   <input type="text" name="q_inp" class="form-control" id="datepicker" value="<?php echo date("Y-m-d H:i:s")?>" >
                 </div>
                 <div class="row">
                              <div class="col-sm-6">
                                <div class="form-group">
...
<div class='form-group'>
                  ...
                  <select name="t_induk" class="form-control select2" id="t_level">
                    ...
                    <option value="">Kelas 7.1</option>
                    <option value="">Kelas 7.2</option>
                    <option value="">Kelas 7.3</option>
                ...
                <div class="row">
                  ...
                  <select name="t_induk" class="form-control select2" id="t_level">
                    ...
                    <option value="">Laik</option>
                    <option value="">Tidak Laik</option>
                  </select>
                </div>
                             </div>
                            </div>
