...
<div class="col-6 animated bounce">
          <div class="card card-pink">
            <div class="card-header">
              ...
              <a href="?user=cetaktanah" class="btn btn-sm btn-flat btn-success animated swing"><i class='fa fa-print'></i> Cetak Tanah</a>
            </div>
            </div>
        ...
        <div class="col-6 animated bounce">
          <div class="card card-pink">
            <div class="card-header">
              ...
              <div class="card-tools">
              <a href="?user=cetakbangunan" class="btn btn-sm btn-flat btn-success animated swing"><i class='fa fa-print'></i> Cetak Bangunan</a>
            </div>
            </div>
...
<div class="col-6 animated bounce">
          <div class="card card-pink">
            <div class="card-header">
              ...
              <div class="card-tools">
              <a href="?user=cetakruang" class="btn btn-sm btn-flat btn-success animated swing"><i class='fa fa-print'></i> Cetak Ruang</a>
            </div>
            </div>
        ...
        <div class="col-6 animated bounce">
          <div class="card card-pink">
            <div class="card-header">
              ...
              <div class="card-tools">
              <a href="?user=cetakbarang" class="btn btn-sm btn-flat btn-success animated swing"><i class='fa fa-print'></i> Cetak Barang</a>
            </div>
            </div>
